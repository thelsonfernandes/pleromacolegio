  ...
  <main id="page-faca-parte" class="page-section">
    ...
    <section class="section-padding"><div class="container">
      ...
      <div class="steps-grid">
        <div class="step-card"><div class="step-number">01</div><h4>Interesse e Envio de Currículo</h4><p style="font-size: 0.9rem; margin-top: 8px;">Manifeste seu interesse e envie seu currículo pelo WhatsApp em um único contato.</p></div>
